 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnType3Impl#getHeader <em>Header</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnType3Impl#getIndex <em>Index</em>}</li>
...
public class ColumnType3Impl extends MinimalEObjectImpl.Container implements ColumnType3 {
	...
	public void setHeader(String newHeader) {
		...
		header = newHeader;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE3__HEADER, oldHeader, header));
	}
	...
	public void setIndex(Object newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE3__INDEX, oldIndex, index));
	}
